 ...
 */
class AsortymentSuszu extends \AppBundle\Entity\AsortymentSuszu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AsortymentSuszu' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AsortymentSuszu' . "\0" . 'asortyment'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AsortymentSuszu $proxy) {
