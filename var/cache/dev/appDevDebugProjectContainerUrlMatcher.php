...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // roleUzytkownika
        if ('/admin/role' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\AdminController::roleUzytkownika',  '_route' => 'roleUzytkownika',);
        }

        // dodajAsortymentSuszu
        if ('/admin/dodajAsortymentSuszu' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\AdminController::dodajAsortymentSuszu',  '_route' => 'dodajAsortymentSuszu',);
        }

        // homepage
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\NarzedziaProdukcyjneController::loginAction',  '_route' => 'homepage',);
            if (substr($pathinfo, -1) !== '/') {
        ...
        if (0 === strpos($pathinfo, '/NarzedziaProdukcyjne')) {
            ...
            if ('/NarzedziaProdukcyjne/RaportSuszenia/Tworzenie/tworzenieRaportuSuszenia' === $pathinfo) {
            ...
            // dodajInfoDodatkowe
            if ('/NarzedziaProdukcyjne/RaportSuszenia/Tworzenie/dodajInfoDodatkowe' === $pathinfo) {
